...
func (h *Handler) ListContacts(c *gin.Context) {
	contacts, err := h.service.ListContacts(c.Request.Context(), middleware.CurrentUserID(c))
	if err != nil {
...
func (h *Handler) ListRequests(c *gin.Context) {
	requests, err := h.service.ListRequests(c.Request.Context(), middleware.CurrentUserID(c), c.Query("status"))
	if err != nil {
		response.Error(c, err)
		return
	}
...
func (h *Handler) SendRequest(c *gin.Context) {
	...
	request, err := h.service.SendRequest(c.Request.Context(), middleware.CurrentUserID(c), req.UserID)
	if err != nil {
		response.Error(c, err)
		return
	}
...
func (h *Handler) AcceptRequest(c *gin.Context) {
	request, err := h.service.AcceptRequest(c.Request.Context(), middleware.CurrentUserID(c), c.Param("request_id"))
	if err != nil {
		response.Error(c, err)
		return
	}
...
func (h *Handler) RejectRequest(c *gin.Context) {
	request, err := h.service.RejectRequest(c.Request.Context(), middleware.CurrentUserID(c), c.Param("request_id"))
	if err != nil {
		response.Error(c, err)
		return
	}
...
func (h *Handler) CancelRequest(c *gin.Context) {
	if err := h.service.CancelRequest(c.Request.Context(), middleware.CurrentUserID(c), c.Param("request_id")); err != nil {
		response.Error(c, err)
		return
	}
