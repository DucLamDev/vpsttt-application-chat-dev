...
Do not commit `android/key.properties`, `.jks`, or `.keystore` files. They are ignored by `mobile/.gitignore`.
...
The static page source lives in `../deploy/download/`. Copy the release
