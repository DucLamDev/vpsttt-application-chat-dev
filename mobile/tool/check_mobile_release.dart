...
void main() {
  final checks = <_ReleaseCheck>[
    ...
    _ReleaseCheck(
      ...
      file: File('../deploy/download/index.html'),
      mustContain: const [
    ...
    _ReleaseCheck(
      ...
      file: File('../deploy/download/styles.css'),
      mustContain: const ['.hero', '.phone-preview', '@media'],
    ),
    _ReleaseCheck(
      label: 'Download page JS',
      file: File('../deploy/download/app.js'),
      mustContain: const [
        'mobile-release-manifest.json',
        'checksum_sha256',
        'download_url',
    ...
    _ReleaseCheck(
      ...
      file: File('../deploy/download/assets/android-chat-preview.png'),
    ),
    _ReleaseCheck(
      label: 'Download page privacy stub',
      file: File('../deploy/download/privacy.html'),
      mustContain: const ['Chính sách riêng tư', 'support@vpsttt.com'],
    ),
    _ReleaseCheck(
      label: 'Download host manifest example',
      file: File('../deploy/download/mobile-release-manifest.example.json'),
      mustContain: const [
